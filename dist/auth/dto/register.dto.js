...
__decorate([
    (0, class_validator_1.IsEnum)(entities_1.TipoPerfil, { message: 'Tipo de perfil inválido' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Tipo de perfil é obrigatório' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "tipoPerfil", void 0);
__decorate([
